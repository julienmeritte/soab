            ...
            <div className="game-page-main">
                <div className="game-page-inner">
                    {winner === -1 ? (
                        ...
                        <div>{winner === playerNumber ? (
                            <div>Vous avez gagné.<br/><a className="nav-link" href="/game">Retour à la liste des jeux.</a></div>
                        ) : (
                            <div>Vous avez perdu.<br/><a className="nav-link" href="/game">Retour à la liste des jeux.</a></div>
                        )}</div>
                    )}
